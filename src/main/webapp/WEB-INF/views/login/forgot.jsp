...
<%@ include file="../util/template.jsp" %>
    <div class="content">
        ...
        <form id="forgot-form" action="forgot" method="post" style =" border : 2px; box-shadow:4px 4px 4px 4px;">
            <h3 class="m-t-10 m-b-10">비밀번호 찾기</h3>
            <p class="m-b-20">입력란에 가입하실 때 입력하신 이메일을 적어주시면 새로운 비밀번호를 보내드리겠습니다.</p>
            <div class="form-group">
                <input class="form-control" type="email" name="userMail" placeholder="Email" autocomplete="off">
            </div>
            <div class="form-group">
